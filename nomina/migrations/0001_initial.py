    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.CharField(choices=[('Heavens Fruits SAS', 'Heavens Fruits SAS'), ('People', 'People'), ('Turnos', 'Turnos')], default='Heavens Fruits SAS', max_length=100, verbose_name='Empresa')),
